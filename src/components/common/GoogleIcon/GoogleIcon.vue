<template>
  <div class="google-icon-container" @click="handleClick">
...
import { handleClickLogic } from './GoogleIcon';
import type { GoogleIconEmits } from './GoogleIcon';
import './GoogleIcon.css';

const emit = defineEmits<GoogleIconEmits>();

const handleClick = (): void => {
  handleClickLogic(emit);
};
</script>